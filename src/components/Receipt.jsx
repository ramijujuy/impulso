    ...
    >
      ...
      <div style={{ display: "flex", borderBottom: "2px solid black" }}>
        <div style={{ flex: 1, padding: "10px" }}>
          <h1 style={{ margin: 0, fontSize: "24px", color: "#5D4037" }}>
            RECIBO
          </h1>
      ...
      <div style={{ padding: "5px 10px", borderBottom: "2px solid black" }}>
        <span style={{ fontWeight: "bold", fontStyle: "italic" }}>Pago:</span>{" "}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div
              style={{
                ...
                borderRadius: "50%",
                backgroundColor:
                  paymentMethod === "transfer" ? "black" : "transparent",
                border: "2px solid black",
              }}
            ></div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div
              style={{
                ...
                borderRadius: "50%",
                backgroundColor:
                  paymentMethod === "cash" ? "black" : "transparent",
                border: "2px solid black",
              }}
            ></div>
          </div>
